    ...
    <header className="sticky top-0 z-50 bg-fds-bg/80 backdrop-blur border-b border-white/10">
      <div className="mx-auto max-w-6xl px-4 py-3 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6 text-sm">
          <Link className="hover:text-fds-accent hover:underline underline-offset-4 decoration-fds-accent/60 transition-colors" href="/products/aviatevfr">AviateVFR</Link>
